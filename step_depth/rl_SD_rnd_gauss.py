...
PPO_MODEL_PATH = "rl/trained on randomDataset(gauss(-1,5))/30000_ppo_deepthought42_random_gauss.zip"  # Change to your model file path
...
with open("stepdepth_0802_(gauss).pkl", "wb") as f:
