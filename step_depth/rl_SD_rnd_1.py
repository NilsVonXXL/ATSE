...
PPO_MODEL_PATH = "rl/trained on randomDataset(-1,1)/50000_ppo_deepthought42_random.zip"  # Change to your model file path
...
with open("stepdepth_0802_(-1,1).pkl", "wb") as f:
